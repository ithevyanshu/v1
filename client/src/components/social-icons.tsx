...
// Main component that exports all icons
export const SocialIcons = {
  Facebook,
  Instagram,
  X, // Use X instead of Twitter
  LinkedIn,
  YouTube
};

// Social platform grid for display
export function SocialIconsGrid() {
  return (
    <div className="flex justify-center space-x-8 md:space-x-12">
      ...
      <div className="text-center">
        <X className="w-10 h-10 mx-auto text-black dark:text-white" />
